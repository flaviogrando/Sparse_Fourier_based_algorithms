...
ylabel('Amplitude (pu)'), xlabel(' Desvio de frequência (Hz) ')
subplot(2,1,2), hold on, grid on
...
%title('Fase (rad)')
%legend('DFT','R-Prony (ref)', 'R-Prony (dft)', 'MR-Prony (ref)', 'MR-Prony (dft)')
ylabel('Fase (rad)'), xlabel(' Desvio de frequência (Hz)')
...
plot(ff, tve(2,:), 'o-')
plot(ff, tve(3,:), 's-')
ylabel('TVE (%)'), xlabel(' Desvio de frequência (Hz) ')
%title('TVE (%)') 
%legend('DFT', 'R-Prony (ref)', 'R-Prony (dft)', 'MR-Prony (ref)', 'MR-Prony (dft)')
...
ylabel('Erro de amplitude (%)'), xlabel(' Desvio de frequência (Hz)} ')
subplot(3,1,3), hold on, grid on
...
ylabel('Erro de fase (º)'), xlabel(' Desvio de frequência (Hz) ')
