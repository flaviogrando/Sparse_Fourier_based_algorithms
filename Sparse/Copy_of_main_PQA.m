...
Fs = 1280;    % Taxa de amostragem
f0 = 50;      % freq. fundamental (teórica)
noise = 50;    % nível de ruído em dB ( 0 = sem ruído)
T = 51*m/Fs;      % tempo total (em segundos)
param = 0;    % amort(w);    % freq. de modulação, por exemplo
type = 0;     % seleciona tipo de teste (ver gerador_sinais.m)

%f1 = 50.12;
%freqs = [49.5 99 148.5 198];        % Vetor de frequências
freqs = [50.23 100.46 150.69 200.92 30 68.6 121.94 175.8];        % Vetor de frequências
...
amps(1,:) = [1 0.86 0.74 0.64 0.085 0.065 0.098 0.051];           % vetor de amplitudes
amps(2,:) = amps(1,:);
amps(3,:) = amps(1,:);
%         1 0.3 0 0 0 0 0 0;
%         1 0.3 0 0 0 0 0 0]; 
