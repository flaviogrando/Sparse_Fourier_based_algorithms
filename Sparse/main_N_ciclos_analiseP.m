...
ff = -5:0.01:5; % frequencias

pp=10:10:1000; % fator de interpolação
...
P = pp(ww);        % Fator de interpolação (expansão do dicionário)
H = N*P;
K = 1;         % Esparsidade
...
ylabel('fator de interpolação');

if algorit == 1
    save('D:\Google drive\MATLAB\QUALI\n_P10_N32_OMP1_ABS.mat', 'tve_p');
else
    save('D:\Google drive\MATLAB\QUALI\n_P10_N32_OMP3_ABS.mat', 'tve_p');
end
